...
import com.maksikos.game.gfx.Colors;
import com.maksikos.game.gfx.Font;
...
public class Player extends Mob {
    ...
    private final int colour = Colors.get(-1, 111, 145, 543);
    ...
    public void tick() {
        ...
        if (xa != 0 || ya != 0) {
            move(xa, ya);
            isMoving = true;
            PacketMove packet = new PacketMove(this.username, this.x, this.y, this.numSteps, this.isMoving, this.movingDir);
